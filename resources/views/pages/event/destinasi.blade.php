...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Data Destinasi Event</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="#">Home</a></li>
                <li class="breadcrumb-item active">Data Destinasi Event</li>
                </ol>
            </div>
            </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="nama_tujuan">Nama Destinasi</label>
                    ...
                    <div class="form-group">
                        <label for="deskripsi_lokasi">Deskripsi</label>
                        <input type="text" class="form-control" id="deskripsi_lokasi" name="deskripsi_lokasi" required>
                    </div>
                </div>
...
@push('scripts')
    ...
    <script>
        ...
        function setDataUpdate(id,nama_tujuan,provinsi,deskripsi_lokasi){
            $('#id').val(id);
            $('#nama_tujuan').val(nama_tujuan);
            $('#provinsi').val(provinsi);
            $('#deskripsi_lokasi').val(deskripsi_lokasi);
        }
        ...
        $('#form-input').on('submit', function(e){
            ...
            var id = $('#id').val();  
            if(id === ""){
                url = "/destinasi/insert";
            }else{
                url = "/destinasi/update";
            }
        ...
        $('#form-gambar').on('submit', function(e){
            ...
            var url = "/destinasi/updategambar";
            var id = $('#idGambar').val();
        ...
        function hapus(id){
            Swal.fire({
                ...
                if (result.value) {
                    $.get(`/destinasi/delete/${id}`, function(data){
                        if(data.status){
                            Swal.fire({
                                title: 'Sukses',
                                text: data.message,
        ...
        function getImages(id){
            ...
            $.get(`/destinasi/getgambar/${id}`, function(data){
