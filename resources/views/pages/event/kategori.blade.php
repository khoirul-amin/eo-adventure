    ...
    <section class="content-header">
        <div class="container-fluid">
            ...
            <div class="col-sm-6">
                ...
                <li class="breadcrumb-item active">Data Kategori Event</li>
                </ol>
            </div>
            </div>
        </div><!-- /.container-fluid -->
...
@push('scripts')
    ...
    <script>
        ...
        function setDataUpdate(id,kategori,email,role,telpon){
            $('#id').val(id);
        ...
        function hapus(id){
            Swal.fire({
                ...
                if (result.value) {
                    $.get(`/kategori/delete/${id}`, function(data){
                        if(data.status){
                            Swal.fire({
                                title: 'Sukses',
                                text: data.message,
