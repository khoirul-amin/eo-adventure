...
--
-- Host: localhost
-- Generation Time: Dec 12, 2021 at 11:32 PM
...
--
-- Database: `u168220287_eo_adventure`
--
...
(1, 'admin', 'admin@gmail.com', '$2a$12$I7XSod1b/jNTLsEp.KgVX.KFqhw4Zhm97ayMSo4wlYfjBM1X3deCC', 1, '2021-12-12 08:35:39', '/avatar/avatar-779619139568cf06.jpg', '085967176070'),
(2, 'Khoirul Amin', 'misbahmis529@gmail.com', '$2y$10$06VFgze7vm2I8rLTXeD5S.VlczzX6jNzO11t/ax7AiX250x9Y20Xe', 2, NULL, '/avatar/avatar-9386191397d07605.jpg', '085967176079');
...
CREATE TABLE `destinasi` (
  ...
  `deskripsi_lokasi` varchar(500) NOT NULL
) ENGINE=InnoDB;
...
CREATE TABLE `transaksi` (
  ...
  `pemberangkatan` timestamp NULL DEFAULT NULL,
  `user_id` int NOT NULL,
  `event_id` int NOT NULL,
  `paket_id` int DEFAULT NULL,
  `bukti_pembayaran` varchar(255) DEFAULT NULL,
  `dadeline_pembayaran` datetime NOT NULL,
  `status_transaksi` int NOT NULL DEFAULT '3' COMMENT '1 Disetujui, 2 Ditolak, 3 Menunggu, 4 Dibatalkan',
...
INSERT INTO `transaksi` (`id`, `invoice`, `tanggal`, `pemberangkatan`, `user_id`, `event_id`, `paket_id`, `bukti_pembayaran`, `dadeline_pembayaran`, `status_transaksi`, `keterangan`, `admin_id`) VALUES
(1, 'TRX121221', '2021-12-03 21:15:23', '2021-12-09 21:16:28', 3, 1, 6, '/images/DEST01images1.png', '2021-12-06 01:04:40', 1, 'Lunas', 1),
(2, 'TRX3202112042', '2021-12-04 10:59:51', '2021-12-09 21:16:28', 3, 2, 11, '/bukti/bukti-73361abb0a91c9ba.jpg', '2021-12-09 04:16:28', 1, 'Lunas, Persiapkan semua yang dibutuhkan untuk pemberangkatan :)', 1);
...
(3, 'Amin', '085967176079', 'amin@gmail.com', '$2y$10$wi22Z49FtlBMC2N3n1tgyOf.a/pmyvqDRstLuemQCxIY1yMHZ81am', '/avatar/avatar-72961917f935b395.jpg', '2021-11-27 22:41:16', 'Tebluru', '$2y$10$2lO5SinsAaZa2pM51ozJ2ew4TO.BheB1ehv/HF8/jK6evISEFcvlG'),
